...
_(100-game browser run, Section 21 above)_
...
_Stock-team harness uses all-balanced players (uniform mods) so BB% is always lower than custom-team games. Movement in the right direction._

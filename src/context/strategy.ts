...
export const stratMod = (
  ...
  const table: Record<Strategy, Record<typeof stat, number>> = {
    balanced: { walk: 0.95, strikeout: 1.0, homerun: 1.0, contact: 1.0, steal: 1.0, advance: 1.0 },
    aggressive: { walk: 0.8, strikeout: 1.1, homerun: 1.1, contact: 1.0, steal: 1.3, advance: 1.3 },
    patient: { walk: 1.1, strikeout: 0.8, homerun: 0.9, contact: 1.0, steal: 0.7, advance: 0.9 },

      ...
      <PlayerMeta>
        <MetaGroup>
          ...
          <SelectInput
            ...
            onChange={(e: React.ChangeEvent<HTMLSelectElement>) => onChange({ position: e.target.value })}
            aria-label="Position"
        ...
        <MetaGroup>
          ...
          <SelectInput
            ...
            onChange={(e: React.ChangeEvent<HTMLSelectElement>) => onChange({ handedness: e.target.value as "R" | "L" | "S" })}

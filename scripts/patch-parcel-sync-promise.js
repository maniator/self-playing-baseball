...
const currentContent = fs.readFileSync(syncPromisePath, 'utf8');

if (currentContent.includes('Local patch: avoid native deasync dependency')) {
  console.log('Parcel syncPromise already patched; skipping.');
  process.exit(0);
}
